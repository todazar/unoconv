...
This fork allows you to select a sheet from a spreadsheet by name. Usage:

    unoconv -f csv --sheet='sheet-name' somefile.xls

Credit for the sheet-selecting functionality goes to zonaj <https://github.com/zonaj>.
I've merely applied the changes to the latest githup unoconv.
